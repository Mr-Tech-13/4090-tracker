...
export const NvidiaEN: Store = {
  ...
  links: [
    ...
    },
    {
      ...
      model: 'founders edition',
      series: '4080-16g',
      url: ' https://store.nvidia.com/en-us/geforce/store/gpu/?page=1&limit=9&locale=en-us&gpu=RTX%204080&category=GPU&manufacturer=NVIDIA&manufacturer_filter=NVIDIA~1,ACER~0,ALIENWARE~0,AORUS~0,ASUS~1,BUILD%20REDUX~0,CLX~0,CORSAIR~0,CYBERPOWER%20PC~0,DELL~0,DIGITAL%20STORM~0,EVGA~0,FALCON%20NW~0,GIGABYTE~2,HP~0,IBUYPOWER~0,LENOVO~0,LG~0,MAINGEAR~0,MSI~4,NZXT~0,ORIGIN%20PC~0,PNY~1,RAZER~0,VIEWSONIC~0,XIDAX~0,ZOTAC~2',
    },
   ],
  name: 'nvidia-en',
};
